<template>
  ...
  <div
    ...
    "
  >
    <div ref="worknavigation" class="work-navigation">
      <div
    ...
    <div ref="infonavigation" class="info-navigation">
      <div
...
const worknavigation = ref(null);
const infonavigation = ref(null);
...
const showElements = (elementArray) => {
  ...
  if (elementArray == "works") {
    showWorkElements.value = !showWorkElements.value;
  } else {
    showInfoElements.value = !showInfoElements.value;
  }
};
